...
Screenshot of objects to be copied from template to working database
...
deleted. You can always use
[`fetchaccess::getTemplateDatabase`](https://wright13.github.io/imd-fetchaccess-package/reference/getTemplateDatabase.md)
to retrieve another copy of it if you need it for another project.
...
Screenshot of export query list in Access, using ‘qExport’ as the prefix
...
[`?fetchaccess::fetchFromAccess`](https://wright13.github.io/imd-fetchaccess-package/reference/fetchFromAccess.md)
at the RStudio console) for more data wrangling and customization
options.
